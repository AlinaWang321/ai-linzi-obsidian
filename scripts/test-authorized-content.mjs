...
assert.match(main, /private authorizedContentFolderPaths: string\[\] = \[\]/)
...
assert.match(main, /从 Obsidian 知识库选择/)
assert.match(main, /从电脑临时选择/)
assert.match(main, /\.png,\.jpg,\.jpeg,\.webp,\.xlsx/)
assert.match(main, /localPathContext: this\.localPathContext\(\)/)
...
assert.match(selector, /folderPaths: string\[\]/)
assert.match(selector, /selectedFolderRoots/)
